...
This document provides guidelines for internationalization of the BitDollar Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitdollar_en.ts` remains unchanged.

...
This mechanism has been integrated into Bitcore-Node-BitDollar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitdollarpay/insight-api-bitdollar#web-socket-api](https://github.com/bitdollarpay/insight-api-bitdollar#web-socket-api)
* API: [https://github.com/bitdollarpay/insight-api-bitdollar#instantsend-transactions](https://github.com/bitdollarpay/insight-api-bitdollar#instantsend-transactions)

...
from test_framework.test_framework import BitDollarTestFramework
...
class LLMQCoinbaseCommitmentsTest(BitDollarTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BitDollarTestFramework doesn't support this atm)

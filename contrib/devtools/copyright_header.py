...
Arguments:
    <base_directory> - The base directory of a BitDollar Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitDollar Core developers'
...
Arguments:
    <base_directory> - The base directory of BitDollar Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BitDollar Core repository.
"""

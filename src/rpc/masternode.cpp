...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner BitDollar address\n"
            "  payee          - Print the masternode payout BitDollar address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting BitDollar address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitdollar",               "masternode",             &masternode,             true,  {} },
    { "bitdollar",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitdollar",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "bitdollar",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

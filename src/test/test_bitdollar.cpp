...
#define BOOST_TEST_MODULE BitDollar Test Suite

#include "test_bitdollar.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitdollar_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

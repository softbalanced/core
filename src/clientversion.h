...
//! These need to be macros, as clientversion.cpp's and bitdollar*-res.rc's voodoo requires it
...
/**
 * bitdollard-res.rc includes this file, but it cannot cope with real c++ code.

...
2. run bitdollard with -printalert or -sendalert like this:
   /path/to/bitdollard -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitdollar.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitDollar Core:0.12.0.58/"));

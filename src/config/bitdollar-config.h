/* src/config/bitdollar-config.h.  Generated from bitdollar-config.h.in by configure.  */
/* src/config/bitdollar-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BTUS_CONFIG_H

#define BTUS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitDollar Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitDollar Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitdollarpay/bitdollar/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitDollar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitDollar Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitdollarcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitdollar.org/"

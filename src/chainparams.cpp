...
// Copyright (c) 2021 The BitDollar Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1621262412, nBits=1e0ffff0, nNonce=222642, vtx=1)
...
{
    const char* pszTimestamp = "n9348bn2398vb572349b34985nb29836n";
    const CScript genesisOutputScript = CScript() << ParseHex("04c412a5935493e3851799d247879eb50d8a63f0bcfe5c4af6251249f547e7f9e4c1ab27bc0d8327155067cd75f9cb10e7281ad98fb00a86a4dfe45fd9bf3e7632") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000285639caa52332013763ae247e19dd04cea00625515809855bd9ae5804c"); 
        ...
        vAlertPubKey = ParseHex("040a5485dd5b87ce1f4393a02907ddaba2ecd6a4531860681014dc122af9afc16f0190adf159ffb073ffa6ba1c625dc98bdf2963b11cc48259f65edff7a72135e2");
        nDefaultPort = 35574;
        ...
        vSeeds.push_back(CDNSSeedData("atl", "atl.softbalanced.com"));
        vSeeds.push_back(CDNSSeedData("chi", "chi.softbalanced.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // BitDollar BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BitDollar BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // BitDollar BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"TKD9veizTmdCrYci9FZ6czeJNbGDix5BDo"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  1, uint256S("0x00000d60c3b391dc6ed932c2fcded39f25a7c2c2a82f9728a901923bbd192f87"))
            (  2, uint256S("0x000000cd98a0b0df4052134f8d67ea4713de6061275516b7480aa0039f39aa81"))
            (  3, uint256S("0x0000011b4341e81229566b2ce1dbf3a2b315eb3d4c8f176c1a8224e6b9d62f46"))
            (  4, uint256S("0x00000119b7954c02f647c919eb7ee7ad2cc29aa8542a651738824aede66a3aaa"))
            (  5, uint256S("0x000004d383ee73b205ff72abb028fdb65d7d165e8fb595fea07091b54c3a0509"))
            (  100, uint256S("0x0000060bd3bed37afd150d2e2f52ae8f791d7e1a15e8fb789a609f6b430c369a"))
            (  1000, uint256S("0x0000051441a756228f20a01794437c309686f246fc5cb62554beaa049757da14"))
            (  10000, uint256S("0x00000004692048f4a03dcd794671daedda1b95a273be4ecbec3771c91fd5598b"))
            (  100000, uint256S("0x00000089542a585186a23ee41ac0fbe8f80e4a79c1c4eaef4b939cfc8e7135c8"))
            (  200000, uint256S("0x000006b28412f1ed68429cc7e747a50bd8b6ed0ded840e1b62f14156760b473d"))
            (  300000, uint256S("0x00000a12a6da4adf6c5e453848cfdafd44bbe6495d8323872e9996224ae803ae"))	
            (  400000, uint256S("00000535080d5e8ed67ba20c68b7643baa89a3e1a394d416a22b9b5b70094ef1"))	
            (  500000, uint256S("000007f7557c466a53c7683df541cee6206c4b4da3b269151503bc97ed5d2161"))	
            (  600000, uint256S("00000eb5f069e72a678843d03a73f094fa41fa75be9aa8e3b4628a1c67ce5fc9"))	
            (  700000, uint256S("00000d1a921e476efe5b619def1e0daebbe23391c529ffa781e09f2912a61f7e"))	
            (  800000, uint256S("00000599ea2a2692dffd24f8ff6add3fdab42c2e35a57cc63d391a628a01bd30"))	
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000df5f6cb789ac218844b6652776930b48f6a6fc6a5cf14e062d6c6d56482"); 

        pchMessageStart[0] = 0x02;
        pchMessageStart[1] = 0xf6;
        pchMessageStart[2] = 0x4a;
        pchMessageStart[3] = 0x63;
        vAlertPubKey = ParseHex("0464572cddb31c92f4bafd03daedf2617d734dd8e8819dec2599ae5ef4390321f62a3465c7d4998abafc93aee99f1d00ab3459f37073e1672ea6c5e213c88c5692");
        nDefaultPort = 45574;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1621262417UL, 108606UL, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000df5f6cb789ac218844b6652776930b48f6a6fc6a5cf14e062d6c6d56482"));
        assert(genesis.hashMerkleRoot == uint256S("0xf2940b292ea6a6e20620d08bc27656b8e445aa5994770feb78a4fe6c762a958c"));
        ...
        // Testnet BitDollar BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitDollar BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet BitDollar BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"MDPdcGFBmkBzap6AvWbzyNZgGbqpa9icPG"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000df5f6cb789ac218844b6652776930b48f6a6fc6a5cf14e062d6c6d56482"))
        };

        chainTxData = ChainTxData{
            1621262417, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1621262422, 0, 0x207fffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x2503a0450cedb003e60b308cd139e1ed9e9ce29a6f34d82af92d77d268751841"));
        assert(genesis.hashMerkleRoot == uint256S("0xf2940b292ea6a6e20620d08bc27656b8e445aa5994770feb78a4fe6c762a958c"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("bitdollarevo.org",  "devnet-seed.bitdollarevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x2503a0450cedb003e60b308cd139e1ed9e9ce29a6f34d82af92d77d268751841"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6yPU5yheUNNd3gNw1i52PuwLdjbRCjP22Rth4wn8jq8puSXTuh3
        vSporkAddresses = {"MDVnsHX3b9eGzYmBc2pXFqojLuox7FWHzZ"};
        nMinSporkKeys = 1;
        ...
        // Regtest BitDollar addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest BitDollar script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest BitDollar BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest BitDollar BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest BitDollar BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

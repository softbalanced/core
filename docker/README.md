...
official/supported Docker Images found at https://hub.docker.com/r/bitdollarpay/bitdollard/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitdollarpay/bitdollard-develop/ when changing the above text**